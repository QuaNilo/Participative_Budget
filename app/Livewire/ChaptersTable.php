...
class ChaptersTable extends Component implements HasForms, HasTable
{
    ...
    {
        $newModel = new Chapter();
        return $table
            ->query(Chapter::query())
            ->columns([
//                TextColumn::make("regulation_id")
//                ->label($newModel->getAttributeLabel("regulation_id"))
//                ->sortable()
//                ->toggleable()
//                ->searchable(),
            ...
            ->actions([
                Action::make('edit')
                ->label(__('Update'))
                ->url(fn (Chapter $record): string => route('chapters.edit', ['chapter' => $record]))
            ...
            ->defaultSort('id', 'desc')
            ->recordUrl(
                fn (Model $record): string => route('chapters.show', ['chapter' => $record]),
            )
            //->striped()
