    ...
    public function table(Table $table): Table
    {
        ...
        return $table
            ...
            ->columns([
                ...
                ->label($newModel->getAttributeLabel("chapter_id"))
                ->sortable()
                ->toggleable()
                ->searchable(),
            ...
            ->actions([
                Action::make('edit')
                ->label(__('Update'))
                ->url(fn (Article $record): string => route('articles.edit', ['article' => $record]))
            ...
            ->defaultSort('id', 'desc')
            ->recordUrl(
                fn (Model $record): string => route('articles.show', ['article' => $record]),
            )
            //->striped()
