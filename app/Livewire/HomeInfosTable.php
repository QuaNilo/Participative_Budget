...
class HomeInfosTable extends Component implements HasForms, HasTable
{
    ...
    public function table(Table $table): Table
    {
        ...
        return $table
            ...
            ->actions([
                Action::make('edit')
                ->label(__('Update'))
                ->url(fn (HomeInfo $record): string => route('home-infos.edit', ['home_info' => $record]))
            ...
            ->defaultSort('id', 'desc')
            ->recordUrl(
                fn (Model $record): string => route('home-infos.show', ['home_info' => $record]),
            )
            //->striped()
