...
{{--<!-- Faq Theme Id Field -->--}}
{{--<div class="mb-3">--}}
{{--    <x-base.form-label for="faq_theme_id">{{ $faq->getAttributeLabel('faq_theme_id') }}</x-base.form-label>--}}
{{--    <x-base.form-input--}}
{{--        class="w-full {{ ($errors->has('faq_theme_id') ? 'border-danger' : '') }}"--}}
{{--        id="faq_theme_id"--}}
{{--        name="faq_theme_id"--}}
{{--        :value="old('faq_theme_id', $faq->faq_theme_id ?? '')"--}}
{{--        type="number"--}}
{{--        step="1"--}}
{{--    />--}}
{{--    @error('faq_theme_id')--}}
...
?>
<div class="mb-3">
    <x-base.form-label for="faq_theme_id">{{ $faq->getAttributeLabel('Theme') }}</x-base.form-label>
