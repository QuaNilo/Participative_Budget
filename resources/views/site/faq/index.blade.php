        ...
        <section class="relative md:py-24 py-16">
            ...
            <div class="container relative md:mt-24 mt-16">
                <div class="grid grid-cols-1 text-center">
                    ...
                    <div class="mt-6">
                        <a href="{{route('contact-us')}}" class="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-primary hover:bg-indigo-700 border-primary hover:border-indigo-700 text-white rounded-md me-2 mt-2"><i class="uil uil-phone"></i> {{__("Contact us")}}</a>
                    </div>
                </div><!--end grid-->
            </div><!--end container-->
        </section>
