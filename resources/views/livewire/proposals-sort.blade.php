<div>
    <button id="dropDownSort" data-dropdown-toggle="dropdownDelaySort" data-dropdown-delay="500" data-dropdown-trigger="hover" class="text-white bg-primary hover:bg-primary-hover focus:ring-4 focus:outline-none focus:ring-primary-hover font-semibold rounded-lg text-sm px-2 py-2 text-center inline-flex items-center" type="button">{{__('Sort By')}} <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
    </svg>
    </button>

    <!-- Dropdown menu -->
    <div id="dropdownDelaySort" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
