...
{{--                        </li>--}}
                        ...
                        <li role="presentation">
                            <x-profile-dashboard-tab :class="$tab === 'votos' ? 'bg-gray-800 text-white' : ''" wire:click="setActiveTab('votos')"><i class="uil uil-heart text-[20px] me-2 align-middle"></i>Votos</x-profile-dashboard-tab>
                        </li>
                        <li role="presentation">
                            <x-profile-dashboard-tab :class="$tab === 'details' ? 'bg-gray-800 text-white' : ''" wire:click="setActiveTab('details')"><i class="uil uil-user text-[20px] me-2 align-middle"></i>Account Details</x-profile-dashboard-tab>
                        </li>
                        <li role="presentation">
                            <x-profile-dashboard-tab :class="$tab === 'update-password' ? 'bg-gray-800 text-white' : ''" wire:click="setActiveTab('update-password')"><i class="uil uil-padlock text-[20px] me-2 align-middle"></i>Update Password</x-profile-dashboard-tab>
                        </li>
                    </ul>
                </div>
            </div><!--end col-->
