        ...
        <form wire:submit="filter">
            <div class="flex bg-white shadow rounded-lg">
                ...
                <div class="relative w-[450px]">
                    ...
                    <button type="submit" class="absolute top-0 end-0 p-2.5 text-sm font-medium h-full text-white bg-primary rounded-e-lg border border-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300">
