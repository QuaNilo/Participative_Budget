                    ...
                    <form wire:submit.prevent="update" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-12 gap-4 mt-4">
                            ...
                            <div class="col-span-12 text-start">
                                ...
                                <textarea id="content" wire:model="content" name="content" class="form-input mt-2 w-full py-2 px-3 h-28 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-primary dark:border-gray-800 dark:focus:border-primary focus:ring-0" placeholder="{{ __('Proposal Description') }} :">{{ old('content') }}</textarea>
                                @error('content')
                                    <div class="mt-2 ps-4 mb-4 text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-span-4 md:inline-block text-start">
                                ...
                                <input id="budget_estimate" wire:model="budget_estimate" type="text" name="budget_estimate" value="{{ old('budget_estimate') }}" class="form-input mt-2 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-primary dark:border-gray-800 dark:focus:border-primary focus:ring-0" placeholder="{{ __('Budget Estimate') }}">
                            ...
                            <div class="md:col-span-4 col-span-6 text-start">
                                ...
                                <input id="url" type="text" wire:model="url" name="url"  value="{{ old('url') }}" class="form-input mt-2 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-primary dark:border-gray-800 dark:focus:border-primary focus:ring-0" placeholder="{{ __('Video URL') }}">
                                @error('url')
                                    <div class="mt-2 ps-4 mb-4 text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-12 gap-4 mt-4">
                            <div class="col-span-12 text-start">
                                ...
                                <input  id="street" type="text" wire:model="street" name="street" value="{{ old('street') }}" class="form-input mt-2 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-primary dark:border-gray-800 dark:focus:border-primary focus:ring-0" placeholder="{{ __('street') }}">
                                @error('street')
                                    <div class="mt-2 ps-4 mb-4 text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="md:col-span-6 col-span-12 text-start">
                                ...
                                <input id="city" type="text" wire:model="city" name="city"  value="{{ old('city') }}" class="form-input mt-2 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-primary dark:border-gray-800 dark:focus:border-primary focus:ring-0" placeholder="{{ __('City') }}">
                                @error('city')
                                    <div class="mt-2 ps-4 mb-4 text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-span-12 text-start mt-8">
                            <input id="lng" hidden wire:model="lng" name="lng" type="text"  class="form-input mt-2 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-primary dark:border-gray-800 dark:focus:border-primary " placeholder="Longitude">
                            <input id="lat" hidden wire:model="lat" name="lat" type="text"  class="form-input mt-2 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-primary dark:border-gray-800 dark:focus:border-primary focus:ring-0" placeholder="Latitude">
                        ...
                        <div class="grid grid-cols-1 gap-4 mt-4">
                            <div>
                                <button type="submit" id="submit" name="send" value="1" class="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center rounded-md bg-primary hover:bg-primary-hover border-primary hover:border-primary-hover text-white">{{__("Edit Proposal")}}</button>
                            </div>
                        </div>
                    </form><!--end form-->
                </div>
