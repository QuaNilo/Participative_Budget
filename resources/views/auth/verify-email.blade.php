        ...
        <x-authentication-card>
            ...
            <div class="mt-4 flex items-center justify-between">
                ...
                <div>
                    <a
                        href="{{ route('profile.show') }}"
                        class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-active dark:focus:ring-offset-gray-800"
                    >
                        {{ __('Edit profile') }}</a>
                    ...
                    <form method="POST" action="{{ route('logout') }}" class="inline">
                        ...
                        <button type="submit" class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-active dark:focus:ring-offset-gray-800 ml-2">
                            {{ __('Log Out') }}
                        </button>
                    </form>
                </div>
