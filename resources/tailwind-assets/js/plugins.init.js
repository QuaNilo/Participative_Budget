...
//=========================================//
    ...
    try {
        var platform = new Choices('#choices');
        // var location = new Choices('#choices-location');
        //var platform_repeator = new Choices('#choices-platform-repeator');
    } catch (error) {
    ...
    try {
        const Default = {
            ...
            inactiveClasses: 'hover:text-primary-hover dark:hover:text-white hover:bg-gray-50 dark:hover:bg-slate-800',
            onShow: () => { }
        }
